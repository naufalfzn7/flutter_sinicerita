...
- [ ] 1. Data model dan core interfaces
  - [ ] 1.1 Buat MessageModel data class di `lib/models/message_model.dart`
  ...
  - [ ]* 1.2 Write property test: MessageModel serialization round-trip
  ...
  - [ ]* 1.3 Write property test: Role getter mutual exclusivity
  ...
  - [ ]* 1.4 Write property test: Missing field rejection
...
- [ ] 2. Tambahkan endpoint constants
  - [ ] 2.1 Tambahkan endpoint constants di `lib/core/api/api_endpoints.dart`
...
- [ ] 3. Extend SessionProvider untuk chat
  - [ ] 3.1 Tambahkan state fields dan methods chat di `lib/providers/session_provider.dart`
  ...
  - [ ]* 3.2 Write property test: Fetch messages produces sorted list
  ...
  - [ ]* 3.3 Write property test: Send message adds both messages on success
  ...
  - [ ]* 3.4 Write property test: Error state consistency after failed send
  ...
  - [ ]* 3.5 Write property test: Error state consistency after failed fetch
  ...
  - [ ]* 3.6 Write property test: Invalid response data throws AppException
  ...
  - [ ]* 3.7 Write property test: GET messages response parsing
...
- [ ] 5. Buat widget ChatBubble dan TypingIndicator
  - [ ] 5.1 Buat ChatBubble widget di `lib/widgets/chat/chat_bubble.dart`
  ...
  - [ ] 5.2 Buat TypingIndicator widget di `lib/widgets/chat/typing_indicator.dart`
...
- [ ] 6. Buat ChatScreen
  - [ ] 6.1 Buat ChatScreen widget di `lib/screens/chat/chat_screen.dart`
  ...
  - [ ] 6.2 Implement input area dan send logic di ChatScreen
  ...
  - [ ]* 6.3 Write property test: Input validation controls send button state
  ...
  - [ ]* 6.4 Write property test: Content is trimmed before sending
...
- [ ] 7. Navigasi dan integrasi
  - [ ] 7.1 Tambahkan route `/chat/:sessionId` di GoRouter configuration (`lib/main.dart` atau router config file)
  ...
  - [ ] 7.2 Implement createSession dan navigasi dari PersonaDetailScreen
  ...
  - [ ] 7.3 Handle error navigasi di ChatScreen
...
- [ ] 9. Unit tests dan widget tests
  - [ ]* 9.1 Write unit tests untuk MessageModel di `test/models/message_model_test.dart`
  ...
  - [ ]* 9.2 Write unit tests untuk SessionProvider chat methods di `test/providers/session_provider_chat_test.dart`
  ...
  - [ ]* 9.3 Write widget tests untuk ChatScreen di `test/screens/chat_screen_test.dart`
